...
def test_numbers_arithmetic_operations():
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=0.03333333333333366), "fix abs_tol so that this assert passes"
...
learnt that stings are represented in single quotes or double quotes
learnt about modulo operator in python
how to use console and learnt about inbuilt function math.isclose
"""